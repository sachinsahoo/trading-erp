...
public class JournalSearchRequest extends AbstractBaseRequest {
    ...
    public JournalSearchRequest(Long myCompanyId, DatePreset datePreset, Long startDate, Long endDate) {
