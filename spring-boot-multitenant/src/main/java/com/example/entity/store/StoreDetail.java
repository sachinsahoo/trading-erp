...
@Entity
@Table(name = "store_detail", schema = "store")

@NamedQueries({
        @NamedQuery(name = "StoreDetail.list", query = "SELECT p from StoreDetail p where p.tenantid=:tenantid"),
        @NamedQuery(name = "StoreDetail.findByName", query = "SELECT p from StoreDetail p where p.name like :name ")

})

public class StoreDetail implements Serializable {
    public static final String Q_PRODUCT_LIST = "StoreDetail.list";
    public static final String Q_FIND_BY_NAME = "StoreDetail.findByName";
