...
drop table inventory.accountbalance;
drop table inventory.completedordersview;
...
from (
    ...
    from (
    	...
    	from inventory.invproduct invp, inventory.poproduct pop, inventory.invoice inv
    	where inv.status = 2
